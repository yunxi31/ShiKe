...
class LocalizationStrings(
    ...
    val defaultPomodoroTitle: String,
    val currentSettingMins: (Int) -> String,
...
val ZhStrings = LocalizationStrings(
    ...
    defaultPomodoroTitle = "默认专注时长 (分钟)",
    currentSettingMins = { "当前设置: $it 分钟" },
...
val EnStrings = LocalizationStrings(
    ...
    defaultPomodoroTitle = "Default Duration (Minutes)",
    currentSettingMins = { "Current: $it min" },
