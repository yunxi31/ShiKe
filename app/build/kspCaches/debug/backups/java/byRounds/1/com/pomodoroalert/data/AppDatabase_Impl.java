  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `tasks` (`taskId` TEXT NOT NULL, `taskName` TEXT NOT NULL, `duration` INTEGER NOT NULL, `status` TEXT NOT NULL, `createdAt` INTEGER NOT NULL, `source` TEXT NOT NULL, `sync_status` TEXT NOT NULL, `priority` INTEGER NOT NULL, `dueDate` INTEGER, `completedAt` INTEGER, PRIMARY KEY(`taskId`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c7751a6897b423dd8afe92e56116d30d')");
      }
    ...
    }, "c7751a6897b423dd8afe92e56116d30d", "9234e065d1a98e4dd88805cd55270248");
