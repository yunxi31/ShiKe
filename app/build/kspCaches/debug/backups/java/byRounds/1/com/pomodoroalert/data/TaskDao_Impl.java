...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntity = new EntityInsertionAdapter<TaskEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`taskId`,`taskName`,`duration`,`status`,`createdAt`,`source`,`sync_status`,`priority`,`dueDate`,`completedAt`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdateTaskStatus = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE tasks SET status = ?, completedAt = ? WHERE taskId = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object updateTaskStatus(final String id, final String newStatus, final Long completedAt,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<TaskEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TaskEntity(_tmpTaskId,_tmpTaskName,_tmpDuration,_tmpStatus,_tmpCreatedAt,_tmpSource,_tmpSyncStatus,_tmpPriority,_tmpDueDate,_tmpCompletedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TaskEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new TaskEntity(_tmpTaskId,_tmpTaskName,_tmpDuration,_tmpStatus,_tmpCreatedAt,_tmpSource,_tmpSyncStatus,_tmpPriority,_tmpDueDate,_tmpCompletedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Flow<List<TaskEntity>> getAllTasks() {
    final String _sql = "SELECT * FROM tasks ORDER BY status ASC, priority DESC, createdAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"tasks"}, new Callable<List<TaskEntity>>() {
      @Override
      @NonNull
